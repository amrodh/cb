                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 property_details_cols">
                        <?php if (is_array($images['src'])): ?>
                            <div id="property_details_images" class="property_borders" style="height:450px; width:500px;position: relative; top: 0px; left: 0px; overflow:hidden;">
                                ...
                                <div u="thumbnavigator" class="jssort01" style="overflow: hidden; position: absolute; width: 450px; height: 100px; right:15px; bottom: 0px;">
                ...
                <div class="modal-dialog">
                  <div class="calculator_modal_content modal-content">
                    <div class="calculator_modal_header">
                      ...
                      <img style="width: 10%; margin-right: 15px" src="<?= base_url();?>/application/static/images/icon_calculator.png">
