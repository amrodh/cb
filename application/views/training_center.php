        ...
        <div class="training_top_div">
            ...
            <div id="training_breadcrumb">
                <ol class="breadcrumb breadcrumb_styling">
                    ...
                    <li class="active">Training Center</li>
                </ol>
            </div>
        </div>
        	...
        	<div class="row">
                <div id="search_header" style="margin-top: -30px;">
                    <ul class="nav nav-tabs nav-justified search_box" id="search_tabs">
                       <li class="active"><a href="#course1" id="training_anchor1" data-toggle="tab">Course 1</a></li>
                       <li><a href="#course2" id="training_anchor3" data-toggle="tab">Course 2</a></li>
                       <li><a href="#course3" id="training_anchor3" data-toggle="tab">Course 3</a></li>
                    </ul>
                </div>
