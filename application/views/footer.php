            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-2 col-md-4 col-sm-4 hidden-xs footer_cols">
                    ...
                    <div class="footer_col_content">
                        <a href="<?= base_url().'en/';?>viewAllProperties?lob=1&type=&city=&district=&contractType=Sale&price=0&area=0"><?php echo $this->lang->line('home_footer_submenu1'); ?><br></a>
                       <!--  <a href="<?= base_url().'en/';?>viewAllProperties"><?php echo $this->lang->line('home_footer_submenu2'); ?><br></a> -->
                        <a href="<?= base_url().'en/';?>viewAllProperties?lob=1&type=&city=&district=&contractType=Rent&price=0&area=0"><?php echo $this->lang->line('home_footer_submenu3'); ?><br></a>
                    </div>
                </div>
                <div class="col-xs-12 col-lg-2 col-md-4 col-sm-4 hidden-xs footer_cols">
                    <div class="footer_col_title">
                    ...
                    <div class="footer_col_content">
                        <a href="<?=base_url();?>en/viewAllProperties?lob=2&type=&city=&district=&contractType=Sale&price=0&area=0"><?php echo $this->lang->line('home_footer_submenu4'); ?><br></a>
                        <a href="<?=base_url();?>en/viewAllProperties?lob=2&type=&city=&district=&contractType=Rent&price=0&area=0"><?php echo $this->lang->line('home_footer_submenu5'); ?><br></a>
                    </div>
                </div>
                <div class="col-xs-12 col-lg-2 col-md-4 col-sm-4 hidden-xs footer_cols">
                    <div class="footer_col_title">
