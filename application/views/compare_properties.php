            ...
            <div class="uploadcv_app_top_div" id="compare_top_divstyle">
                ...
                <div class="">
                    <ol class="breadcrumb compare_breadcrumb">
                        <li><a href="<?=base_url();?>"><?php echo $this->lang->line('compare_breadcrumb1'); ?></a></li>
                        <li><a href="<?=base_url();?>en/viewAllProperties"><?php echo $this->lang->line('compare_breadcrumb2'); ?></a></li>
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-inline" id="property_form" role="form" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="property_first_name" name="property_first_name" placeholder="Enter First Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="property_last_name" name="property_last_name" placeholder="Enter Last Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="email" class="form-control" id="property_email" name="property_email" placeholder="Enter E-mail">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="property_phone" name="property_phone" placeholder="Enter Phone">
                                        </div>
                                    </div>
                                    <div class="form-group">
