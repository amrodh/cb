<?php
    ...
    function searchService($inputs , $client)
    {
        ...
        $inputs = array(
            ...
            'searchDateAnchor' => $inputs['searchDateAnchor']
            );
              ...
              if (!in_array($value, $DBPropertiesKeys)){
                ...
                $LocationType = $serviceResults[$key]['LocationType'];
                    $sqlInsert = "INSERT INTO property_service (AreaNumericValue, AreaUnit, AreaunitStr, BalconiesNumber, BathRoomsNumber, BedRoomsNumber,
                      InteriorFinishing, LineofBusinessFK, LocationCity, LocationDistrict, LocationProject, LocationType, PropertyTypeFK, PrpertyTypeStr, RentCurrency, 
                      ...
                      '$LocationDistrict', '$LocationProject', '$LocationType', '$PropertyTypeFK', '$PrpertyTypeStr', '$RentCurrency', '$RentPrice', 
                  ...
                  $LocationType = $serviceResults[$key]['LocationType'];
                    ...
                    if (mysqli_query($con, $sqlInsert))
                    {
                      print_r('updated: '. $PropertyId);
                    }else{
                      print_r('failed update: '.$PropertyId);
                    }
                    insertPropertyImage($PropertyId, $UnitId, $client, $con);
              }
            }
